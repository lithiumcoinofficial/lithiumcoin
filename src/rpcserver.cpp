...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lithium features */
        {"lithium", "masternode", &masternode, true, true, false},
        {"lithium", "masternodelist", &masternodelist, true, true, false},
        {"lithium", "mnbudget", &mnbudget, true, true, false},
        {"lithium", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lithium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lithium", "mnsync", &mnsync, true, true, false},
        {"lithium", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lithium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lithiumd, or the -server option to lithium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43673/\n";
}
