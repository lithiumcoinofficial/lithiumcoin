                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LIT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LIT address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LIT Core"), this);
    aboutAction->setStatusTip(tr("Show information about LIT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LIT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LIT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LIT addresses"));
    ...
    openAction->setStatusTip(tr("Open a LIT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LIT Core help message to get a list with possible LIT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LIT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LIT network", "", count));
}
...
{
    QString strTitle = tr("LIT Core"); // default title
