/* src/config/lithium-config.h.  Generated from lithium-config.h.in by configure.  */
/* src/config/lithium-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.lithium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lithium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lithium Core 2.3.0"
