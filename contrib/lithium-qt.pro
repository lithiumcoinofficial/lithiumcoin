...
RESOURCES += src/qt/lithium.qrc src/qt/lithium_locale.qrc

TRANSLATIONS += src/qt/locale/lithium_bg.ts \
                src/qt/locale/lithium_de.ts \
                src/qt/locale/lithium_en.ts \
                src/qt/locale/lithium_es.ts \
                src/qt/locale/lithium_fi.ts \
                src/qt/locale/lithium_fr.ts \
                src/qt/locale/lithium_it.ts \
                src/qt/locale/lithium_ja.ts \
                src/qt/locale/lithium_pl.ts \
                src/qt/locale/lithium_pt.ts \
                src/qt/locale/lithium_ru.ts \
                src/qt/locale/lithium_sk.ts \
                src/qt/locale/lithium_sv.ts \
                src/qt/locale/lithium_vi.ts \
                src/qt/locale/lithium_zh_CN.ts \
                src/qt/locale/lithium_zh_TW.ts
