...
In order to support loading of multiple wallets in lithium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lithium.cpp.
...
Changes to lithium.cpp
----------------------
lithium.cpp is the entry point into lithium-qt, and as such, will require some minor modifications to provide hooks for
