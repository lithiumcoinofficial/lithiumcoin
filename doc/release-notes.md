LIT Core version 2.3.0 is now available from:

  <https://github.com/lithium-project/lithium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/lithium-project/lithium/issues>

Compatibility
==============

LIT Core is extensively tested on multiple operating systems using
...
LIT Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) LIT MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode LIT address
...
LIT Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for LIT (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with LIT (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/lithium-project-translations/).
